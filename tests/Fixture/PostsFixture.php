...
class PostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'title' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'published' => 1,
                'created' => '2020-08-09 18:01:46',
                'modified' => '2020-08-09 18:01:46',
            ],
        ];
        parent::init();
    }
